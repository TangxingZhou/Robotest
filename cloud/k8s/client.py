...
class K8sClient:
    ...
    @property
    def core_matrixone_cloud_v1alpha1_api(self):
        return moc.MOCV1alpha1Api(self.api_client)

    @property
    def core_matrixorigin_io_v1alpha1_api(self):
        return moc.MOIV1alpha1Api(self.api_client)

    @property
    def events_v1_api(self):
        return client.EventsV1Api(self.api_client)
