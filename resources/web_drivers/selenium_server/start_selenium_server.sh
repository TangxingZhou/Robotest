...
sleep 2
nohup java -Dwebdriver.chrome.driver=$chrome_driver_path -jar selenium-server-standalone-$selenium_server_version.jar -role node -nodeConfig node_config.json > $selenium_server_logs_dir/selenium_server_node.log &
